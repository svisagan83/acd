...
stuControllers.controller("custSearch", function ($scope, $http) {
    $http.get("/api/MRCorporates/").success(function (data) {
        debugger;
        $scope.students = data;
    });
    //  $scope.users = [
...
stuControllers.controller('CtrlTest', function ($scope, $filter, $http) {
    //$scope.users = [
    //   { id: 1, name: 'awesome user1', status: 2, group: 4, groupName: 'admin' },
    //   { id: 2, name: 'awesome user2', status: undefined, group: 3, groupName: 'vip' },
    //   { id: 3, name: 'awesome user3', status: 2, group: null }
